...
The files include fasta sequences (TEfastasequences.fa) of several L1s (L1HS, L1preTa, L1PA2, L1PA6, L1) and Alus (AluJb, AluY, AluJr, AluSp, AluSq, AluJo, AluYb8, AluYa5, AluSx) which can be used in running sTELLeR as well as another fasta file (TEsequences_SVA_HERV_ALU_L1.fasta) also containing HERV and SVA sequences. 
